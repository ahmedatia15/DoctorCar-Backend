...
const CATALOG = [
  ...
  { legacyId: 2, name: "فلتر هواء تويوتا كورولا", category: "فلاتر", price: 145, oemNumber: "17801-21050", inStock: true, image: "assets/images/products/bmw_oil_filter.png", description: "فلتر هواء عالي الجودة يوفر تدفق هواء أنظف للمحرك." },
  ...
  { legacyId: 10, name: "فلتر زيت BMW", category: "فلاتر", price: 170, oemNumber: "11427512300", inStock: true, image: "assets/images/products/toyota_corolla_air_filter.png", description: "فلتر زيت يوفر حماية أفضل للمحرك من الشوائب والرواسب." },
...
// Idempotently ensure the catalog matches CATALOG — always upserts each entry
// so updates to image paths, prices, etc. propagate to the live DB on the next
// request without needing a manual migration.
